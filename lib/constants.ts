...
export const MODULES = [
  {
    ...
    desc: "Un sistema para todos tus puntos de venta",
    features: [
  ...
  },
  {
    ...
    desc: "Tu vendedor solo ve ventas. Tú ves todo.",
    features: [
  ...
  },
  {
    icon: "📦",
    name: "Inventario",
    desc: "Stock en tiempo real con trazabilidad total",
    features: [
  ...
  },
  {
    icon: "💰",
    name: "Ventas / POS",
    desc: "Vende rápido, con o sin internet",
    features: [
  ...
  },
  {
    icon: "🛒",
    name: "Compras",
    desc: "Del pedido al almacén sin sorpresas",
    features: [
  ...
  },
  {
    icon: "💳",
    name: "Finanzas",
    desc: "CxC, CxP, gastos y flujo de caja",
    features: [
  ...
  },
  {
    ...
    desc: "Timbrado ante el SAT sin complicaciones",
    features: [
      "CFDI directo desde la venta con un clic",
      "PAC integrado: Facturama",
      "Cancelación con sustitución",
      "PDF, XML y envío por correo automático",
      "Facturación en lote para múltiples ventas",
    ],
  },
  {
    icon: "👥",
    name: "Clientes y Proveedores",
    desc: "Nunca pierdas de vista quién te debe",
    features: [
  ...
  },
  {
    ...
    desc: "Tu catálogo público conectado al inventario",
    features: [
      "URL pública: plataforma.pycore.app/p/tu-negocio",
      "Stock en tiempo real, nunca vendas lo que no tienes",
      "Checkout con Mercado Pago integrado",
      "Pedidos programados (panadería, despensa, etc.)",
  ...
  },
  {
    ...
    desc: "Expediente y asistencia de tu equipo",
    features: [
  ...
  },
  {
    icon: "🔔",
    name: "Notificaciones",
    desc: "Alertas en tiempo real, dentro y fuera del sistema",
    features: [
      "Notificaciones push incluso con la pestaña cerrada",
      "Mensajes del admin a roles específicos",
      "Alertas automáticas del sistema",
      "Avisos de TEZCA integrados",
